...
#include "w3d_device/game_client/W3DProjectedShadow.h"
...
#include "game_logic/ScriptEngine.h" // For TheScriptEngine - jkmcd
...
AGAIN:
	...
	if (loc.X > 128)
		theLightXOffset = -theLightXOffset;
	if (loc.X < 0)
		theLightXOffset = -theLightXOffset;
	loc.Y += theLightYOffset;
	if (loc.Y > 128)
		theLightYOffset = -theLightYOffset;
	if (loc.Y < 0)
		theLightYOffset = -theLightYOffset;

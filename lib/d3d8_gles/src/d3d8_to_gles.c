...
D3DXVECTOR3 *WINAPI D3DXVec3Subtract(D3DXVECTOR3 *pOut, CONST D3DXVECTOR3 *pV1,
...
D3DXVECTOR3 *WINAPI D3DXVec3Cross(D3DXVECTOR3 *pOut, CONST D3DXVECTOR3 *pV1,
                                  CONST D3DXVECTOR3 *pV2) {
...
D3DXVECTOR4 *WINAPI D3DXVec4Transform(D3DXVECTOR4 *restrict pOut,
                                      ...
                                      CONST D3DXMATRIX *restrict pM) {
  pOut->x =
      pV->x * pM->_11 + pV->y * pM->_21 + pV->z * pM->_31 + pV->w * pM->_41;
  pOut->y =
      pV->x * pM->_12 + pV->y * pM->_22 + pV->z * pM->_32 + pV->w * pM->_42;
  pOut->z =
      pV->x * pM->_13 + pV->y * pM->_23 + pV->z * pM->_33 + pV->w * pM->_43;
  pOut->w =
      pV->x * pM->_14 + pV->y * pM->_24 + pV->z * pM->_34 + pV->w * pM->_44;
  return pOut;
}

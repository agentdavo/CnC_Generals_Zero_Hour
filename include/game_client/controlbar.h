...
enum
{
	MAX_COMMANDS_PER_SET = 12
}; // user interface max button limit for commands
enum
{
	MAX_RIGHT_HUD_UPGRADE_CAMEOS = 5
};
enum
{
...
enum
{
	MAX_STRUCTURE_INVENTORY_BUTTONS = 10
}; // there are this many physical buttons in "inventory" windows for structures
enum
{
	MAX_BUILD_QUEUE_BUTTONS = 9
}; // physical button count for the build queue
enum
{
	MAX_SPECIAL_POWER_SHORTCUTS = 5
};

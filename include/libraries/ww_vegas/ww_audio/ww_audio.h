...
private:
	...
	typedef struct _CACHE_ENTRY_STRUCT
	{
		...
		bool operator== (const _CACHE_ENTRY_STRUCT &src) const { return false; }
		bool operator!= (const _CACHE_ENTRY_STRUCT &src) const { return true; }
	} CACHE_ENTRY_STRUCT;
	...
	typedef struct _LOGICAL_TYPE_STRUCT
	{
		...
		bool operator== (const _LOGICAL_TYPE_STRUCT &src) const { return false; }
		bool operator!= (const _LOGICAL_TYPE_STRUCT &src) const { return true; }
	} LOGICAL_TYPE_STRUCT;

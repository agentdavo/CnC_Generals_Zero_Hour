...
public:
	PartitionFilterInsignificantBuildings(Bool allowNonBuildings, Bool allowInsignificant) : m_allowNonBuildings(allowNonBuildings), m_allowInsignificant(allowInsignificant) {}
...
public:
	PartitionFilterGarrisonableByPlayer(Player *player, Bool match, CommandSourceType commandSource) : m_player(player), m_match(match), m_commandSource(commandSource)
	{
	}
...
public:
	PartitionFilterValidCommandButtonTarget(Object *source, const CommandButton *commandButton, Bool match, CommandSourceType commandSource) : m_source(source), m_commandButton(commandButton), m_match(match), m_commandSource(commandSource) {}
